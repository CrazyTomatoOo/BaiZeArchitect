...
const CONTENT: Record<string, () => unknown> = {
	...
	scenario: () => ({ schemaVersion: "artifact/scenario/v1", artifactKind: "scenario", summary: "S", sourceRefs: [{ type: "requirement_revision", revisionId: 1 }], domains: [{ nodeId: "d1", title: "D", scenarios: [{ nodeId: "s1", title: "T", variants: [{ nodeId: "v1", title: "V", actors: ["U"], preconditions: ["P"], trigger: "Tr", mainFlow: ["F"], alternateFlows: [], expectedOutcome: "O" }] }] }] }),
	...
	function: () => ({ schemaVersion: "artifact/function/v1", artifactKind: "function", summary: "F", sourceRefs: [{ type: "requirement_revision", revisionId: 1 }], domains: [{ nodeId: "d1", title: "D", items: [{ nodeId: "i1", title: "I", points: [{ nodeId: "p1", name: "N", responsibility: "R", inputs: ["I"], outputs: ["O"], businessRules: ["B"], acceptanceCriteria: ["A"] }] }] }] }),
	...
	architecture: () => ({ schemaVersion: "artifact/architecture/v1", artifactKind: "architecture", summary: "Arch", sourceRefs: [{ type: "requirement_revision", revisionId: 1 }], components: [{ componentId: "c1", name: "N", responsibility: "R" }], relationships: [{ relationshipId: "r1", fromComponentId: "c1", toComponentId: "c2", interaction: "I" }], constraints: ["C"], nonFunctionalRequirements: ["N"] }),
	data: () => ({ schemaVersion: "artifact/data/v1", artifactKind: "data", summary: "Data", sourceRefs: [{ type: "requirement_revision", revisionId: 1 }], entities: [{ entityId: "e1", name: "E", fields: [{ fieldId: "f1", name: "f", type: "string" }] }], relations: [{ fromEntityId: "e1", fromFieldIds: ["f1"], toEntityId: "e2", cardinality: "one-to-many" }] }),
	api: () => ({ schemaVersion: "artifact/api/v1", artifactKind: "api", summary: "API", sourceRefs: [{ type: "requirement_revision", revisionId: 1 }], openapi: "3.1.0", info: { title: "API", version: "1" }, paths: { "/expire": { summary: "Expire", post: { summary: "Expire", responses: { "200": { description: "OK" } } } } } }),
};
