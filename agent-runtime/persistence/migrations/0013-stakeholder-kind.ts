/**
 * 0013-stakeholder-kind.ts — 资产库新增第四种可复用资产 kind=stakeholder（干系人）。
 *
 ...
 */
export const STAKEHOLDER_KIND_MIGRATION = {
	version: 13,
	name: "stakeholder-kind",
	sql: `
create table reusable_assets_new (
	id integer primary key,
	workspace_id integer not null references workspaces(id) on delete restrict,
	kind text not null check (kind in ('scenario','usecase','function','stakeholder')),
	title text not null,
