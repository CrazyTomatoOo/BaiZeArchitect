...
- [Define the accessibility, testing, and acceptance bar](issues/08-define-accessibility-testing-and-acceptance-bar.md) — Google Chrome is the sole release browser; semantic list/live-region behavior, four automated test layers, performance budgets, three viewports, and Chrome manual exploration are mandatory before cutover.
